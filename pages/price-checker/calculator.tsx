        ...
        <Alert className="mt-4 space-y-4 text-lg p-6">
          ...
          <AlertDescription className="text-base">
            <ol className="text-gray-800 space-y-2 list-decimal list-inside">
              ...
              <li>Completá con los otros medios de pago, agregando los que más descuento tengan primero</li>
              <li>El Restante se va a actualizar con el descuento que tenga el Medio de pago seleccionado</li>
            </ol>
          </AlertDescription>
        </Alert>
      </div>
