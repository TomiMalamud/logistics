...
const formSchema = z.object({
  ...
  orderIds: z.array(z.number()).min(1, "Seleccioná al menos una orden"),
});
...
export function PaymentForm({ user, onSuccess, trigger }: Props) {
  ...
  }, [completedOrders, selectedOrderIds]);

  // Update amount when orders are selected
  React.useEffect(() => {
    form.setValue("amount", selectedOrdersTotal);
  }, [selectedOrdersTotal, form]);
