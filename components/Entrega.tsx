  ...
  return (
    <div className="rounded-lg space-y-2 bg-white border p-6">
              ...
              {entrega.customers.celular && (
                <>
                  <DropdownMenuItem>
                    ...
                    <a className="ml-2" href={`https://wa.me/54${entrega.customers.celular}`}>
                      WhatsApp
                    </a>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Phone size={15} />
                    <a className="ml-2" href={`tel:${entrega.customers.celular}`}>
                      Llamar
                    </a>
                  </DropdownMenuItem>
                </>
      ...
      <div className="flex py-2 items-center justify-between">
        <p className="text-sm text-slate-600 mr-5">{entrega.customers.domicilio}</p>
        <Button
          variant="outline"
          onClick={entregaLogic.openInGoogleMaps}
      ...
      <div className="w-full space-x-2 pt-4 flex items-center justify-between">
        ...
        <Button
          ...
          disabled={entregaLogic.isAddingNote || !entregaLogic.newNote.trim()}
        >
      ...
      <div className="pt-2">
        <EstadoDialog
          ...
          handleConfirmEstadoChange={entregaLogic.handleConfirmEstadoChange}
